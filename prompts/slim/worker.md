...
On a retry, address each valid, concrete finding before your final response.
If this says `(no prior reviewer feedback)`, this is the
...
- You may self-test as needed. The runner performs authoritative deterministic
  verification after your process exits; do not create or modify its evidence.

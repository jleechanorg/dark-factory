...
# ---------------------------------------------------------------------------
# Contract-echo subsystem (issue #386) — moved to runner.skeptic_contract_echo
# ---------------------------------------------------------------------------
#
# The contract-echo types / regexes / loader / parser / evaluator now live
# in `runner.skeptic_contract_echo`. The skeptic_gate re-exports the
# public surface here so existing callers (skeptic_gate_cli, downstream
# workers, tests) keep working, and the new module provides the canonical
# location for the contract-echo subsystem's tests + future maintenance.

from runner.skeptic_contract_echo import (  # noqa: F401
    AcceptanceItem,
    BeadContract,

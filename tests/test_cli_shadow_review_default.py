...
def test_cli_enables_ordinary_shadow_codex_review_by_default(tmp_path, monkeypatch, capsys):
...
def test_cli_shadow_codex_review_can_be_disabled(tmp_path, monkeypatch, capsys):
    from runner import __main__ as cli

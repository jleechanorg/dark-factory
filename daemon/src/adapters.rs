...
pub fn is_graphql_rate_limited() -> bool {
    crate::gh_circuit_breaker::global().is_open()
}

pub fn mark_graphql_rate_limited(duration: Duration) {
    crate::gh_circuit_breaker::global().force_open(duration, "graphql_rate_limit");
}

pub fn clear_graphql_rate_limited() {
    crate::gh_circuit_breaker::global().force_close();
}

...
fn test_reroll_success() {
    ...
    *llm.response.borrow_mut() = Some(Ok(
    ...
    // jleechan-wuts / issue #349 (r2): the reroll now routes through
...
/// Regression test for bead jleechan-wuts / issue #349 (r2) — the
...
/// returns Err for `main` in this test, so a regression to the old code
/// path fails the reroll outright.
#[test]

...
rg -q 'Delivery-unconfirmed/blocked sessions \(native acknowledgement not observed; duplicate suppressed\): 1' <<<"$body"
rg -q 'Native-ack tracking \(new records only\): observed 1, missing 1, untracked/legacy 4' <<<"$body"

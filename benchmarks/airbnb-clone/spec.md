...
- `listings/{listingId}` — title, description, type, country, city, lat/lng, nightly price (USD cents), max guests, bed/bath counts, amenity slugs, `hostId` (owner uid, denormalized), rating, reviewCount, status, timestamps.
